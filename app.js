...
refs.galleryList.insertAdjacentHTML('beforeend', listItemsMurkup);
...
function createListItemsMurkup(data) {
...
function closeModalWindowKeydown(evt) {
...
function addImageOnLightbox(evt) {
  refs.lightboxImage.src = evt.target.getAttribute('data-source');
